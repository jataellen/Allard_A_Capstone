...
#### For printing predictions progress in command line
print_prog_check = input("\nWould you like to see extraction progress as the files are processed? Please type 'yes'\n\n")

if print_prog_check == 'yes':
    print_progress = True
    print()
else:
...
if print_progress:
    print("Case text extracted from HTML files...")
...
if print_progress:
    print("Text pre-processed...")
    print("Text split into metadata and content...")
...
if print_progress:
    print("Adjudicating member extracted...")
...
if print_progress:
    print("Case outcome text span extracted...")

######################################## GRACE -- ADD YOUR STUFF HERE -- KEEP ADDING TO data_df ########################################



## Grace's wonderful code here
...
if print_progress:
    print("\nExtractions complete. Writing information to a CSV. Check pipeline_output directory for generated CSV")
